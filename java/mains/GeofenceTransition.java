...
public class GeofenceTransition extends IntentService {
    ...
    private void sendNotification( String msg ) {
        ...
        Intent notificationIntent = GeofenceLocation.makeNotificationIntent(
                getApplicationContext(), msg
        );

        TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);
        stackBuilder.addParentStack(GeofenceLocation.class);
    ...
    private Notification createNotification(String msg, PendingIntent notificationPendingIntent) {
        ...
        notificationBuilder
                ...
                .setColor(Color.RED)
                .setContentTitle(msg)
                .setContentText("You hae entered a geofence!")
